...
public class ToyotaEntity extends GeoVehicleEntity {
    ...
    private static final EntityDataAccessor<Float> STEERING_ANGLE = SynchedEntityData.defineId(ToyotaEntity.class, EntityDataSerializers.FLOAT);
    ...
    public void baseTick() {
        ...
        if (isMoving && Math.abs(currentAngle) > 1f) {
            float turnAmount = currentAngle * 0.01f * (float)speed;
