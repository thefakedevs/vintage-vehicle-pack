...
public class ukr_chestRenderer extends GeoArmorRenderer<ukr_chest> {
	public ukr_chestRenderer() {
		super(new ukr_chestModel());
	...
	@Override
	public RenderType getRenderType(ukr_chest animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
