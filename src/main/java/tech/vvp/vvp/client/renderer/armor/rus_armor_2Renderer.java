...
public class rus_armor_2Renderer extends GeoArmorRenderer<rus_armor_2> {
	public rus_armor_2Renderer() {
		super(new rus_armor_2Model());
	...
	@Override
	public RenderType getRenderType(rus_armor_2 animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
