...
public class pmc_v2_chestRenderer extends GeoArmorRenderer<pmc_v2_chest> {
	public pmc_v2_chestRenderer() {
		super(new pmc_v2_chestModel());
	...
	@Override
	public RenderType getRenderType(pmc_v2_chest animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
