...
public class rus_armorRenderer extends GeoArmorRenderer<rus_armor> {
	public rus_armorRenderer() {
		super(new rus_armorModel());
	...
	@Override
	public RenderType getRenderType(rus_armor animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
