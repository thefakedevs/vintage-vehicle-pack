...
public class pmc_chestRenderer extends GeoArmorRenderer<pmc_chest> {
	public pmc_chestRenderer() {
		super(new pmc_chestModel());
	...
	@Override
	public RenderType getRenderType(pmc_chest animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
